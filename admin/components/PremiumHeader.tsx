  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-[#800080]/90 backdrop-blur-lg shadow-lg shadow-[#800080]/30'
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/" className="flex items-center space-x-2 group">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg group-hover:shadow-[#FFD700]/50 transition-shadow duration-300">
                <span className="text-[#800080] font-bold text-xl">IW</span>
              </div>
              <div className="hidden sm:block">
                <h1 className="text-white font-bold text-xl tracking-wide">IWKL</h1>
                <p className="text-[#FFD700] text-xs font-medium tracking-wider">INDIAN WOMEN KABADDI LEAGUE</p>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden sm:flex items-center space-x-3">
              ...
              <Link
                href="/register"
                className="px-4 py-2 bg-[#FFD700] text-[#800080] rounded-lg font-semibold hover:bg-[#FFD700]/90 transition-all duration-200 shadow-lg shadow-[#FFD700]/30 text-sm"
              >
                Register
              </Link>
            </div>
