            ...
            return Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text('Team ${index + 1}', style: const TextStyle(color: Colors.white))),
                  Text('${22 - index * 2}', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                ],
              ),
            );
          }),
